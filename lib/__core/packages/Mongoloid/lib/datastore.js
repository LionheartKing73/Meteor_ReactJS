 ...
 */
Datastore.prototype.find = function (query, projection, callback = function(){}) {
 ...
 * @param {Object} projection MongoDB-style projection
 */
Datastore.prototype.findOne = function (query, projection, callback = function(){}) {
  ...
  return new Promise((resolve, reject) => {
    ...
    var cursor = new Cursor(this, query, function (err, docs, callback) {
      ...
      if (docs.length === 1) {
        var _res = model.deepCopy(docs[0]);
        resolve(_res);
